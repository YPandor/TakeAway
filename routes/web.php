...
Route::get('/pizzas/{pizza_id}', 'PizzaController@show')->name('pizzas.show')->middleware('auth');
Route::delete('/pizzas/{pizza_id}', 'PizzaController@destroy')->name('pizzas.destroy')->middleware('auth');
